...
public class RestService
{
	...
	@ResponseBody
	public ResponseEntity<String> getEntityByGlobalID(@PathVariable("globalID") String globalID) throws InterruptedException, ExecutionException, CipherException, IOException {
...
//	}
	...
	public ResponseEntity<String> putData(@RequestBody String hexValue) throws ExecutionException, InterruptedException {
	...
	@ResponseBody
	public ResponseEntity<String> getNonceByAccountAddress(@PathVariable("address") String address) throws InterruptedException, ExecutionException, CipherException, IOException {
